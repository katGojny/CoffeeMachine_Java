class TimeConstantsDemo {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(TimeConstants.SECONDS_IN_A_WEEK);// print SECONDS_IN_DAY
...
final class TimeConstants {
    ...
    public static final int SECONDS_IN_A_DAY = 24 * SECONDS_IN_HOUR;
    public static final int SECONDS_IN_A_WEEK = 7 * SECONDS_IN_A_DAY;// write your code here
